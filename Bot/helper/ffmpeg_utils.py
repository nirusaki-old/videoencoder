...
def encode(filepath):
    ...
    if video_codec[0] == 'hevc':
        ...
        video_opts = '-map 0 -c:v libx265 -metadata title=animeplex -pix_fmt yuv420p -preset medium -tune psnr -s 854x480 -crf 28.5 -b:v 260k'
    ...
    if audio_codec == []:
        ...
        audio_opts = '-c:a libopus -ac 2 -vbr 2  -ab 32k -c:s copy'
